...
namespace QuodAstrum.Items.Weapons
{
    public class HellsGaze : ModItem
    {
        ...
        public override void SetDefaults()
        {
            ...
            item.autoReuse = true;
            item.shoot = mod.ProjectileType("Pentagram");  //this make the item shoot your projectile
        ...
        public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
        {
            ...
            for (int i = 0; i < numberProjectiles; i++)
            {
                ...
                type = Main.rand.Next(new int[] { type, ProjectileID.DemonScythe, ProjectileID.UnholyTridentFriendly, mod.ProjectileType("Pentagram") });
            }
            return true;
